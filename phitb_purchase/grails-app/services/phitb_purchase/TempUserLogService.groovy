...
class TempUserLogService {
    ...
    def getAll(String limit, String offset, String query) {
        ...
        if (!query)
            ...
            return TempUserLog.findAllBySeriesIlike("%" + query + "%", [sort: 'id', max: l, offset: o, order: 'desc'])
    }
    ...
    TempUserLog save(JSONObject jsonObject) {
        ...
        tempUserLog.series = jsonObject.get("series").toString()
