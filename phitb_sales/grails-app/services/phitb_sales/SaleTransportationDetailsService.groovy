...
class SaleTransportationDetailsService
{
    ...
    SaleTransportationDetails save(JSONObject jsonObject)
    {
        ...
        saleTransportationDetails.generalInfo = jsonObject.get("generalInfo").toString()
        saleTransportationDetails.selfNo = jsonObject.get("selfNo").toString()
        saleTransportationDetails.ccm = jsonObject.get("ccm").toString()
        saleTransportationDetails.receivedTemperature = jsonObject.get("receivedTemperature").toString()
        saleTransportationDetails.freightCharge = jsonObject.get("freightCharge").toString()
        saleTransportationDetails.vehicleId = Long.parseLong(jsonObject.get("vehicleId").toString())
    ...
    {
        SaleTransportationDetails saleTransportationDetails = SaleTransportationDetails.findById(Long.parseLong(jsonObject.id.toString()))
        if (SaleProductDetails)
        {
            ...
            saleTransportationDetails.selfNo = jsonObject.get("selfNo").toString()
            saleTransportationDetails.ccm = jsonObject.get("ccm").toString()
            if(jsonObject.has("receivedTemperature"))
                saleTransportationDetails.receivedTemperature = jsonObject.get("receivedTemperature").toString()
            saleTransportationDetails.freightCharge = jsonObject.get("freightCharge").toString()
