...
class SaleBillDetailsService
{
    ...
    SaleBillDetails save(JSONObject jsonObject)
    {
        ...
        saleBillDetails.entryDate = sdf.parse(jsonObject.get("priorityId").toString())
        ...
        saleBillDetails.creditadjAmount = Long.parseLong(jsonObject.get("creditadjAmount").toString())
