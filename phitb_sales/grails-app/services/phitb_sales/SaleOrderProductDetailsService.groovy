...
class SaleOrderProductDetailsService {
    ...
    SaleOrderProductDetails save(JSONObject jsonObject)
    {
        ...
        saleOrderProductDetails.originalSqty = Double.parseDouble(jsonObject.get("originalSqty").toString())
        saleOrderProductDetails.originalFqty = Double.parseDouble(jsonObject.get("originalFqty").toString())
