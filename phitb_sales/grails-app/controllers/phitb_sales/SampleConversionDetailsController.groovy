...
class SampleConversionDetailsController {
    ...
    /**
     * Gets all Sample Conversion Details
     * @param query
     * @param offset
     * @param limit
     * @return list of Sample Conversion Details
     */
    def index() {
    ...
    /**
     * Get requested Sample Conversion Details
     * @param id
     * @return get requested Sample Conversion Details
     */
    def show() {
        try {
            String id = params.id
    ...
    /**
     * Save new Sample Conversion Details
     * @param Sample Conversion Details
     * @return saved Sample Conversion Details
     */
    def save() {
        try {
    ...
    /**
     * Delete selected Sample Conversion Details
     * @param id
    ...
    /**
     * Gets all Sample Conversion Details in datatables format
     * @return list of  Sample Conversion Details
     */
    def dataTable() {
        try {
