...
module.exports = function(Chart) {
	 ...
	 * @prop {Number} left - Left edge of the item. Set by layout phitb_ui.system and cannot be used in update
	 * @prop {Number} top - Top edge of the item. Set by layout phitb_ui.system and cannot be used in update
	 * @prop {Number} right - Right edge of the item. Set by layout phitb_ui.system and cannot be used in update
	 * @prop {Number} bottom - Bottom edge of the item. Set by layout phitb_ui.system and cannot be used in update
	 */
