...
class ProductClassController {
    ...
    def index()
    {
        ...
        */
            render(view: '/product/productClass/productClass')
        }
        catch (Exception ex)
        {
    ...
    def save()
    {
        try
        {
            ...
            def apiResponse = new ProductService().saveProductClass(jsonObject)
            if (apiResponse?.status == 200)
            {
    ...
    def update()
    {
        try
        {
            ...
            def apiResponse = new ProductService().putProductClass(jsonObject)
            if (apiResponse.status == 200)
            {
                JSONObject obj = new JSONObject(apiResponse.readEntity(String.class))
                respond obj, formats: ['json'], status: 200
    ...
    def delete()
    {
        ...
        {
            JSONObject jsonObject = new JSONObject(params)
            def apiResponse = new ProductService().deleteProductClass(jsonObject)
            if (apiResponse.status == 200)
            {
    ...
    def show()
    {
        try
        {
            def apiResponse = new ProductService().getProductClass()
            if (apiResponse?.status == 200)
            {
