<div class="example-modal">
    <div class="modal fade" id="adddayEndModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="dayEndTitle"></h4>
                </div>
                <form action="" id="form_validation" method="post" role="form" class="dayEndForm"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="date" class="form-control date datetimepicker" name="date"
                                       placeholder="Date"
                                       required/>
                            </div>
                            ...
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="endTime" class="form-control endTime datetimepicker" name="endTime"
