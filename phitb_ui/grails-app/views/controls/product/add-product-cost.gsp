<div class="example-modal">
    <div class="modal fade" id="addproductCostModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="productCostTitle"></h4>
                </div>
                <form action="" id="form_validation" method="post" role="form" class="productCostForm"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="priceType" class="form-control priceType" name="priceType"
                            ...
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="number" id="minimumRate" class="form-control minimumRate" name="minimumRate"
                                       placeholder="Minimum Rate"
                                       required/>
                            </div>

                            <div class="col-lg-6 form-group  form-float">
                                <label for="maximumRate">
                                    Maximum Rate
                                </label>
                                <input type="number" id="maximumRate" class="form-control maximumRate" name="maximumRate"
