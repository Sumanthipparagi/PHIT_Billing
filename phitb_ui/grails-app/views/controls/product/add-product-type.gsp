    ...
    <div class="modal fade" id="addproductTypeModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="" id="form_validation" method="post" role="form" class="productTypeForm"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="productType" class="form-control productType" name="productType"
                            ...
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="productDescription" class="form-control productDescription" name="productDescription" placeholder="Product Description" required/>
                            </div>
