<div class="example-modal">
    <div class="modal fade" id="addproductScheduleModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="productScheduleTitle"></h4>
                </div>
                <form action="" id="form_validation" method="post" role="form" class="productScheduleForm"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="scheduleCode" class="form-control scheduleCode" name="scheduleCode"
                            ...
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <input type="text" id="scheduleDescription" class="form-control scheduleDescription" name="scheduleDescription" placeholder="Schedule Description" required/>
                            </div>
