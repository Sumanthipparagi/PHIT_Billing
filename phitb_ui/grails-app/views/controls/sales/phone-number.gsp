        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input placeholder="Phone Number" maxlength="10" style="width: 100%" type="tel" class="phoneNumber form-control"
                           name="phoneNumber" id="phono" minlength="10" pattern="[789][0-9]{9}"/>
                </div>
            </div>
