                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover transportTable dataTable">
                                <thead>
                                <tr>
...
<script>
    ...
    $(".transportForm").submit(function (event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Transport Type Submitted Successfully", "success");
                transportTable();
    ...
    function deleteData() {
        $.ajax({
            ...
            success: function () {
                ...
                transportTable();
                Swal.fire("Success!", "Transport Type Deleted Successfully", "success");
            }, error: function () {
                Swal.fire("Error!", "Something went wrong", "error");
            }
        });
