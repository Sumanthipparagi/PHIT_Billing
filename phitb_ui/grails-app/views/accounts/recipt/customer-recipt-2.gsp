                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 form-group  form-float">
                                ...
                                <select class="show-tick paymentMode" name="paymentMode"
                                    ...
                                    <option value="" data-mode="">-- Please select --</option>
...
<script>
    ...
    function payMode(mode) {
        ...
        if ($('#paymentMode option:selected').attr('data-mode') === "CARD") {
            ...
            $(".accountMode").hide().prop('required', false)
            $("#deposit").show()
        }
        if ($('#paymentMode option:selected').attr('data-mode') === "CASH") {
            ...
            $(".cheque").hide().prop('required', false)
            $(".accountMode").hide().prop('required', false)
            $("#deposit").hide().prop('required', false)
        }
    ...
    $(document).on('keyup', '.txtgtn', function (e) {
        var id = $(this).attr('data-gtnid');
        var bal = Number($(this).attr('data-gtnbal')).toFixed(2)
        var value = $('#paidNowGtn' + id).val();
        if (Number(value) > Number(bal)) {
            Swal.fire({
                position: 'top-end',
                icon: 'error',
        ...
        if(amountPaid!==0 && amountPaid!=="" && !isNaN(amountPaid))
        {
            $.each(invIdArray, function (key, value) {
                ...
                if (invBal > amountPaid) {
                    $('#paidNowInv' + value).val(amountPaid.toFixed(2));
                    amountPaid = 0;
                } else {
