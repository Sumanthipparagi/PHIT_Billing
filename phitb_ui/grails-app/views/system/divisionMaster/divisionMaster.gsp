                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover divisionTable dataTable">
                                <thead>
                                <tr>
                                    %{--                                    <th style="width: 20%">ID</th>--}%
                                    <th style="width: 20%">Division Name</th>
                                    <th style="width: 20%">Division Code</th>
...
<g:include view="controls/add-division.gsp"/>
...
<script>
    ...
    function divisionTable() {
        divisiontable = $(".divisionTable").DataTable({
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            ...
                            ' data-divisionCode="' + json.data[i].divisionCode + '"' +
                            ' data-regionCode="' + json.data[i].regionCode + '"' +
                        ...
                        return_data.push({
                            // 'id': json.data[i].id,
                            'regionName': json.data[i].divisionName,
                            'regionCode': json.data[i].regionCode,
                            'divisionCode': json.data[i].divisionCode,
            ...
            columns: [
                ...
                {'data': 'divisionCode', 'width': '20%'},
                {'data': 'regionCode', 'width': '20%'},
                {'data': 'action', 'width': '5%'}
            ]
        });
    }
    ...
    $(document).on("click", ".editbtn", function () {
        ...
        $(".regionCode").val($(this).attr('data-regionCode')).change();
        $(".divisionCode").val($(this).attr('data-divisionCode'));
