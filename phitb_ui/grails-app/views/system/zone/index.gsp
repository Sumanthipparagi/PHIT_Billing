                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addZoneModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Zones</font></font></button>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table
                                    class="table table-bordered table-striped table-hover zone">
                                <thead>
                                <tr>
...
<g:include view="controls/add-zone.gsp"/>
...
<script>
            ...
            ajax: {
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        console.log(json)
                        var editbtn = '<button type="button" data-name="'+json.data[i].name+'" data-id="' + json.data[i].id +
                            '" class="editbtn btn btn-sm btn-warning" data-toggle="modal" data-target="#addZoneModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".zoneForm").submit(function (event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Zone Submitted Successfully", "success");
                zone();
