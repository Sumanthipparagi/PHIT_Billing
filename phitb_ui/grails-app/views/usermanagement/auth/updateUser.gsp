                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <input type="text" id="userName"
                                                                   class="form-control userName" name="userName" placeholder="User Name" value="${user.userName}" required/>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <input type="text" id="aadharId"
                                                                   class="form-control aadharId" name="aadharId" placeholder="Aadhar Id" value="${user.aadharId}" required/>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <input type="text" id="referenceRelation" class="form-control referenceRelation"
                                                                   ...
                                                                   placeholder="Reference Relation"  value="${user.referenceRelation}"
                                                                   required/>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <select class="form-control show-tick bankId" name="bankId" id="bankId">
                                                                ...
                                                                <g:each var="b" in="${bank}">
                                                                    <option value="${b?.id}" <g:if test="${b?.id ==
                                                                            user.bankId}">selected</g:if>>${b?.bankName}</option>
                                                                </g:each>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <input type="text" id="assignedHolidays" class="form-control assignedHolidays"
                                                                   name="assignedHolidays"
                                                                   placeholder="Assigned Holidays"  value="${user.assignedHolidays}"
                                                                   required/>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 form-group  form-float">
                                                            ...
                                                            <select class="form-control show-tick account" name="account" id="account">
                                                                <g:each var="a" in="${account}">
                                                                    <option value="${a.id}" <g:if test="${a.id == user.account.id}">selected</g:if>>${a.accountName}</option>
                                                                </g:each>
                                                            </select>
                                                        </div>
