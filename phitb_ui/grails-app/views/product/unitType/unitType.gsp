                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addunitTypeModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Unit Type</font></font></button>
                    </div>
                    <div class="body">
...
<g:include view="controls/product/add-unitType.gsp"/>
...
<script>
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            '" data-unitName="' + json.data[i].unitName + '"' +
                            '" data-entityId="' + json.data[i].entityId + '"' +
                            '" data-entityType="' + json.data[i].entityTypeId + '"' +
                            '"' +
                            ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addunitTypeModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".unitTypeForm").submit(function (event) {
    ...
    $(document).on("click", ".addbtn", function () {
        $(".unitTypeTitle").text("Add Unit Type");
        $(".unitTypeForm")[0].reset();
        id = null
    });
    ...
    $(document).on("click", ".deletebtn", function () {
        id = $(this).data('id');
        $("#myModalLabel").text("Delete Unit Type ?");
