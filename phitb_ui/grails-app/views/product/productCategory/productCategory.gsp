...
<head>
  ...
  <title>:: PharmIt :: Product Category</title>
        ...
        <div class="card">
          ...
          <div class="header">
            <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                    data-target="#addproductCategoryModal"><font style="vertical-align: inherit;"><font
                    style="vertical-align: inherit;">Add Product Category</font></font></button>
          </div>
          <div class="body">
...
<g:include view="controls/product/add-product-category.gsp"/>
...
<script>
  ...
  function fridgeTable() {
    productcategorytable = $(".fridgeTable").DataTable({
      ...
      ajax: {
        type: 'GET',
        url: '/phitb_ui.product-category/datatable',
        dataType: 'json',
        dataSrc: function (json) {
          ...
          for (var i = 0; i < json.data.length; i++) {
            ...
            var editbtn = '<button type="button" data-id="' + json.data[i].id +
                    ...
                    '"' +
                    ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addproductCategoryModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
  ...
  $(".productCategoryForm").submit(function (event) {
    ...
    var type = '';
    if (id) {
      url = '/phitb_ui.product-category/update/' + id;
      type = 'POST'
    } else {
      url = '/phitb_ui.product-category';
      type = 'POST'
    }
  ...
  $(document).on("click", ".addbtn", function () {
    $(".productCategoryTitle").text("Add Product Category")
  ...
  function deleteData() {
    $.ajax({
      type: 'POST',
      url: '/phitb_ui.product-category/delete/' + id,
      dataType: 'json',
      success: function () {
