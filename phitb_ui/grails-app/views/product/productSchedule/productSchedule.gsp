...
<head>
    ...
    <title>:: PharmIt :: Product Schedule</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item active">Product Schedule</li>
                    </ul>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addproductScheduleModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Product Schedule</font></font></button>
                    </div>
                    <div class="body">
...
<g:include view="controls/product/add-product-schedule.gsp"/>
...
<script>
    ...
    function fridgeTable() {
        productcategorytable = $(".fridgeTable").DataTable({
            ...
            serverSide: true,
            language: {
                searchPlaceholder: "Search Project Schedule"
            },
            ajax: {
                type: 'GET',
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            '" data-scheduleCode="' + json.data[i].scheduleCode + '"' +
                            '" data-scheduleDescription="' + json.data[i].scheduleDescription + '"' +
                            '" data-entityId="' + json.data[i].entityId + '"' +
                            '" data-entityType="' + json.data[i].entityTypeId + '"' +
                            '"' +
                            ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addproductScheduleModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".productScheduleForm").submit(function (event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Product Category Submitted Successfully", "success");
                fridgeTable();
                $('#addproductScheduleModal').modal('hide');
            },
            error: function () {
    ...
    $(document).on("click", ".addbtn", function () {
        $(".productScheduleTitle").text("Add Product Schedule")
        $(".productScheduleForm")[0].reset();
        id = null
    });

    $(document).on("click", ".editbtn", function () {
        id = $(this).data('id');
        $(".scheduleCode").val($(this).attr('data-scheduleCode'));
        $(".scheduleDescription").val($(this).attr('data-scheduleDescription')).change();
    ...
    $(document).on("click", ".deletebtn", function () {
        id = $(this).data('id');
        $("#myModalLabel").text("Delete Product Schedule ?");
    ...
    function deleteData() {
        $.ajax({
            ...
            success: function () {
                ...
                fridgeTable();
                Swal.fire("Success!", "Product Schedule Deleted Successfully", "success");
            }, error: function () {
                Swal.fire("Error!", "Something went wrong", "error");
            }
        });
