...
<script>
    ...
    function fridgeTable() {
        productcategorytable = $(".fridgeTable").DataTable({
            ...
            ajax: {
                type: 'GET',
                url: '/product-composition/datatable',
                dataType: 'json',
    ...
    $(".productCompostionForm").submit(function (event) {
        ...
        var type = '';
        if (id) {
            url = '/product-composition/update/' + id;
            type = 'POST'
        } else {
            url = '/product-composition';
            type = 'POST'
        }
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Product Composition Submitted Successfully", "success");
                fridgeTable();
    ...
    function deleteData() {
        $.ajax({
            type: 'POST',
            url: '/product-composition/delete/' + id,
            dataType: 'json',
            success: function () {
                $('.deleteModal').modal('hide');
                fridgeTable();
                Swal.fire("Success!", "Product Composition Deleted Successfully", "success");
            }, error: function () {
                Swal.fire("Error!", "Something went wrong", "error");
            }
        });
