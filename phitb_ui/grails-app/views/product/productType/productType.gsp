...
<head>
    ...
    <title>:: PharmIt :: Product Type</title>
                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addproductTypeModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Product Type</font></font></button>
                    </div>
                    <div class="body">
...
<g:include view="controls/product/add-product-type.gsp"/>
...
<script>
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            '" data-productType="' + json.data[i].productType + '"' +
                            '" data-productDescription="' + json.data[i].productDescription + '"' +
                            '" data-entityId="' + json.data[i].entityId + '"' +
                            '" data-entityType="' + json.data[i].entityTypeId + '"' +
                            '"' +
                            ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addproductTypeModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".productTypeForm").submit(function (event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Product Type Submitted Successfully", "success");
                fridgeTable();
    ...
    $(document).on("click", ".addbtn", function () {
        $(".productTypeTitle").text("Add Product Type")
    ...
    $(document).on("click", ".editbtn", function () {
        ...
        $(".productDescription").val($(this).attr('data-productDescription')).change();
    ...
    $(document).on("click", ".deletebtn", function () {
        id = $(this).data('id');
        $("#myModalLabel").text("Delete Product Type ?");
    ...
    function deleteData() {
        $.ajax({
            ...
            success: function () {
                ...
                fridgeTable();
                Swal.fire("Success!", "Product Type Deleted Successfully", "success");
            }, error: function () {
                Swal.fire("Error!", "Something went wrong", "error");
            }
        });
