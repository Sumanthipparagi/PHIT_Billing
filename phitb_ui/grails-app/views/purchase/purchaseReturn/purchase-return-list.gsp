...
<script>
    ...
    function purchaseInvoiceTable() {
        ...
        entityregister = $(".saleInvoiceTable").DataTable({
            ...
            language: {
                searchPlaceholder: "Purchase Return"
            },
            ajax: {
                type: 'GET',
                url: '/purchase-return/datatable',
                data: {
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var printbtn = '<a target="_blank" class="btn btn-sm btn-danger" data-id="' + json.data[i].id
                            + '" href="/purchase-return/print-invoice?id=' + json.data[i].id +
    ...
    function cancelBill(id) {
        Swal.fire({
            title: "Cancel this Purchase Return? this can't be undone.",
            showDenyButton: true,
