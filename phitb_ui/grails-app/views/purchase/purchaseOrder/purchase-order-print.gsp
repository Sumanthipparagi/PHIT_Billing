...
<head>
    ...
    <script type="text/javascript">
        ...
        %{--    var nric = '${purchaseOrderDetail.invoiceNumber}';--}%
...
<table id="prodDetails" class="extended" style="width: 100%; padding: 5%;">
    ...
    <tr>
        ...
        <td colspan="5" style="vertical-align:top;font-size:8pt;"><b>Bill to Address :(${supplier.id})</b><br>
            <b>${supplier.entityName}</b><br>
            <sub>${supplier.addressLine1}${supplier.addressLine2}
            </sub>
        </td>
        <td colspan="5" style="vertical-align:top;font-size:8pt;"><b>Ship to Address :(${supplier.id})</b><br>
            <b>${supplier.entityName}</b><br>
            <sub>${supplier.addressLine1}${supplier.addressLine2}
            </sub>
        </td>
        <td colspan="4" style="vertical-align:top;font-size:8pt;">
            ...
            <ul style="margin: 0;">
                ...
                <li><b class="tab">Invoice No</b>:  <strong><g:if test="${purchaseOrderDetail.billStatus == 'CANCELLED'}"><del>${purchaseOrderDetail.invoiceNumber}</del></g:if><g:else>${purchaseOrderDetail.invoiceNumber}</g:else></strong></li>
    ...
    <g:each var="sp" in="${purchaseOrderProductDetails}" status="i">
        <tr>
            <td>${i + 1}</td>
    ...
    <tr>
        <td colspan="14" style="border: 0"><g:if test="${purchaseOrderDetail.billStatus == 'CANCELLED'}">
...
%{--    <g:if test="${purchaseOrderDetail.billStatus == 'CANCELLED'}">--}%
%{--        <div id="watermark" class="print-watermark">CANCELLED</div>--}%
%{--    </g:if>--}%
%{--    <g:elseif test="${purchaseOrderDetail.billStatus == 'DRAFT'}">--}%
%{--        <div id="watermark" class="print-watermark">DRAFT</div>--}%
...
<script>
    window.onload = function () {
        ...
        %{--    text: ' ${purchaseOrderDetail.invoiceNumber}',--}%
        %{--    width: 128,--}%
        %{--    height: 128,--}%
        %{--    colorDark : '#000000',--}%
        %{--    colorLight : '#fff',--}%
        ...
        var invDate = new Date('${purchaseOrderDetail.dateCreated}');
        var dueDate = new Date('${purchaseOrderDetail.dueDate}');
        $("#invDate").text(moment(invDate).format('DD-MM-YYYY'));
        $("#dueDate").text(moment(dueDate).format('DD-MM-YYYY'));

        <g:each var="spd" in="${purchaseOrderProductDetails}">
    ...
    var qrText = '${purchaseOrderDetail.invoiceNumber}';
    <g:if test="${irnDetails != null}">
