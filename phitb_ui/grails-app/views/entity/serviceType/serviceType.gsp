...
<head>
    ...
    <title>:: PharmIt :: Service Type</title>
                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addserviceTypeModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Service Type</font></font></button>
                    </div>
                    <div class="body">
...
<g:include view="controls/entity/add-servicetype.gsp"/>
...
<script>
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            '" data-serviceType="' + json.data[i].serviceType + '"' +
                            ...
                            '"' +
                            ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addserviceTypeModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".serviceTypeForm").submit(function (event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                Swal.fire("Success!", "Service Type Submitted Successfully", "success");
                seriesTable();
    ...
    $(document).on("click", ".addbtn", function () {
        $(".serviceTypeTitle").text("Add Service Type")
    ...
    $(document).on("click", ".editbtn", function () {
        ...
        $(".desc").val($(this).attr('data-description'));
    ...
    $(document).on("click", ".deletebtn", function () {
        id = $(this).data('id');
        $("#myModalLabel").text("Delete Service Type ?");
    ...
    function deleteData() {
        $.ajax({
            ...
            success: function () {
                ...
                seriesTable();
                Swal.fire("Success!", "Service Type  Deleted Successfully", "success");
            }, error: function () {
                Swal.fire("Error!", "Something went wrong", "error");
            }
        });
