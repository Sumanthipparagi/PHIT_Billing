...
<head>
    ...
    <title>:: PharmIt :: Entity IRN</title>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table
                                    class="table table-bordered table-striped table-hover entityIRN">
                                <thead>
                                <tr>
...
<script>
    ...
    $(document).on("click", ".deletebtn", function () {
        id = $(this).data('id');
        $("#myModalLabel").text("Delete Entity IRN?");
