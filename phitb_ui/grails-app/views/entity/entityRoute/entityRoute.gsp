                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addEntityRouteModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Routes</font></font></button>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table
                                    class="table table-bordered table-striped table-hover entityRoute">
                                <thead>
                                <tr>
...
<g:include view="controls/entity/add-entityroute.gsp"/>
...
<script>
    ...
    $(".entityRouteForm").submit(function (event) {
        ...
        $.ajax({
            ...
            success: function () {
                ...
                entityRoute();
                $('#addEntityRouteModal').modal('hide');
            },
            error: function () {
    ...
    $(document).on("click", ".addbtn", function () {
        $(".entityRouteForm")[0].reset();
        id = null;
        $(".entityRouteTitle").text("Add Entity Route ?");
