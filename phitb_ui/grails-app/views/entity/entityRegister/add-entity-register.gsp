                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 form-group  form-float">
                                            <label for="pinCode">
                                                PIN Code <span class="required-indicator" style="color: red;">*</span>
                                            </label>
                                        ...
                                        <div class="col-lg-6 form-group  form-float">
                                            <label for="hqarea">
                                                HQ Area <span class="required-indicator" style="color: red;">*</span>
                                            </label>
                                        ...
                                        <div class="col-md-6 form-group  form-float">
                                            <label for="countryId">
                                                Country <span class="required-indicator" style="color: red;">*</span>
                                            </label>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2" style="border: 1px solid rgba(13,10,10,0.4);border-radius:10px;padding: 10px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 form-group  form-float">
                                        ...
                                        <input type="number" id="noOfCrDays" class="form-control noOfCrDays"
                                               name="noOfCrDays" placeholder=" Number Of Credit Days" value="0"/>
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group  form-float">
                                        ...
                                        <input type="number" id="noOfGraceDays" class="form-control noOfGraceDays"
                                               name="noOfGraceDays" placeholder="Number Of Grace Days" value="0"/>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 form-group  form-float">
                                        ...
                                        <input type="number" id="openingBalance"
                                               class="form-control openingBalance" onblur="setTwoNumberDecimal()"
                                    ...
                                    <div class="col-lg-6 form-group  form-float">
                                        ...
                                        <input type="number" id="currentBalance"
                                               class="form-control currentBalance" onblur="setTwoNumberDecimal()"
                                               step="0.25" value="0.00"
...
--}%
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="number" id="phoneNumber" class="form-control phoneNumber"
                                                       name="phoneNumber" placeholder="Phone Number" value="${entity.repPhoneNumber}"/>
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="text" id="aadharId" class="form-control aadharId"
                                                       name="aadharId" placeholder="Enter Aadhaar Number" value="${entity.aadharId}"/>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="text" id="drugLicenceValidity"
                                                       ...
                                                       placeholder=" Drug Licence Validity" alue="${entity.drugLicenceValidity}"/>
                                            </div>
                                    ...
                                    <div class="col-md-6 mt-2" style="border: 1px solid rgba(13,10,10,0.4);border-radius:10px;padding: 10px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="number" id="noOfCrDays" class="form-control noOfCrDays"
                                                       name="noOfCrDays" placeholder=" Number Of Credit Days" value="${entity.noOfCrDays}"/>
                                            </div>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="number" id="discount" class="form-control discount"
                                                       name="discount" placeholder="Discount"
                                                       onblur="setTwoNumberDecimal()" step="0.25"  value="${entity.discount}" required/>
                                            </div>
        ...
        --}%
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="number" id="defaultCharge" class="form-control defaultCharge"
                                                       onblur="setTwoNumberDecimal()" step="0.25"value="${entity.defaultCharge}"
                                                       name="defaultCharge" placeholder="Default Charge"
                                                       required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group  form-float">
                                                ...
                                                <input type="number" id="salesmanCommission"
                                                       class="form-control salesmanCommission"
                                                       name="salesmanCommission" placeholder="Salesman Commission"
                                                       onblur="setTwoNumberDecimal()" step="0.25" value="${entity.salesmanCommission}"/>
                                            </div>
