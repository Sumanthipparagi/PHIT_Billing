...
<head>
    ...
    <title>:: PharmIt :: Financial Year Master</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item active">Financial Year Master</li>
                    </ul>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="header">
                        <button type="button" class="btn btn-round btn-primary m-t-15 addbtn" data-toggle="modal"
                                data-target="#addfinancialYearModal"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Add Financial year</font></font></button>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover financialYearTable dayEndTable">
                                <thead>
                                <tr>
...
<g:include view="controls/entity/add-financial-year.gsp"/>
...
<script>
    ...
    function financialYearTable() {
        fiancialyeartable = $(".financialYearTable").DataTable({
            "order": [[0, "desc"]],
            ...
            ajax: {
                type: 'GET',
                url: '/financial-year-master/datatable',
                dataType: 'json',
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var editbtn = '<button type="button" data-id="' + json.data[i].id +
                            '" data-startDate="' + json.data[i].startDate + '"' +
                            '" data-endDate="' + json.data[i].endDate + '"' +
                            '" data-entitytype="' + json.data[i].entityType.id + '"' +
                            '" data-entityRegister="' + json.data[i].entity.id + '"' +
                            '"' +
                            ' class="editbtn btn btn-sm btn-warning  editbtn" data-toggle="modal" data-target="#addfinancialYearModal"><i class="material-icons"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">edit</font></font></i></button>'
    ...
    $(".financialYearForm").submit(function (event) {
        ...
        var type = '';
        if (id) {
            url = '/financial-year-master/update/' + id;
            type = 'POST'
        } else {
            url = '/financial-year-master';
            type = 'POST'
        }
    ...
    function deleteData() {
        $.ajax({
            type: 'POST',
            url: '/financial-year-master/delete/' + id,
            dataType: 'json',
            success: function () {
