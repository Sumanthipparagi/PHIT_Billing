                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="invoiceStatus">Delivery Challan status</label>
...
<script>
    ...
    function saleInvoiceTable() {
        ...
        entityregister = $(".saleInvoiceTable").DataTable({
            ...
            ajax: {
                type: 'GET',
                url: '/delivery-challan/datatable',
                data: {
                ...
                dataSrc: function (json) {
                    ...
                    for (var i = 0; i < json.data.length; i++) {
                        ...
                        var printbtn = '<a target="_blank" class="btn btn-sm btn-danger" data-id="' + json.data[i].id
                            + '" href="/delivery-challan/print-delivery-challan?id=' + json.data[i].id +
    ...
    function cancelDeliveryChallan(id, customerId) {
        Swal.fire({
            title: "Cancel this Delivery Challan? this can't be undone.",
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                var url = '/delivery-challan/cancel?id=' + id +'&customerId='+customerId;
                var beforeSendSwal;
                $.ajax({
                    type: "GET",
                    url: url,
    ...
    function approveDeliveryChallan(dc) {
        Swal.fire({
            title: "Approve this Delivery Challan? this can't be undone.",
            showDenyButton: true,
            showCancelButton: false,
            confirmButtonText: 'Yes',
            denyButtonText: 'No',
            ...
            if (result.isConfirmed) {
                var url = '/delivery-challan/approve?deliveryChallan=' + dc;
                var beforeSendSwal;
                $.ajax({
                    type: "GET",
                    url: url,
