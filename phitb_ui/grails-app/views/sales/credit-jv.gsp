...
<table style="width:1308px;table-layout: auto;">
    ...
    <tr>
        ...
        <td style="width: 25%;vertical-align:top;">
            To, <b>OM SREE LAKSHMI PHARMA</b><br>
            <sub>TRR ARCADE 4/5, 3RD FLOOR 1ST MAIN ROAD GOKULA 1ST STAGE MATTIKERE MAIN RD GOKULA 1ST STAGE KA-KARNATAKA
        ...
        <td style="width: 25%;vertical-align:top;">
            <ul style="margin: 0;">
                <li><b class="tab">Credit JV No</b>: 013/21/CP/1</li>
                <li><b class="tab">Date</b>: 14-07-2021</li>
                <li><b class="tab">Reason</b>: : EXTRA FREE SCHEME CLAIM</li>
            </ul>
        </td>
...
<table style="width:1308px;table-layout: auto;">
    ...
    <tr>
        <td style="width: 56%">
            <b>Credited Amount</b>
            <p>Debit Account : SALES A/C</p>
           <p ><b>Note : It is the responsibility of the all recipients to
           discharge liability towards service tax and GST (if any) to
           the concerned authorities and the company shall not be held
           responsible for any such violations.</b></p>
        </td>
