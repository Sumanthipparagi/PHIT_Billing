...
<div id="wrapper">
    ...
    <table id="prodDetails" class="extended" style="width: 100%; padding: 5%;border: 1px solid #000;">
        <div class="page-header">
            ...
            <tr>
                ...
                <td colspan="5" style="vertical-align:top;font-size:8pt;">
                    <strong>GST DELIVERY CHALLAN</strong>
                    <ul style="margin: 0;">

                        <li><b class="tab">Invoice No</b>:  <strong style="font-size: 13px;"><g:if
                                test="${sampleInvDetail.billStatus == 'CANCELLED'}"><del>${sampleInvDetail.invoiceNumber}</del></g:if><g:else>${sampleInvDetail.invoiceNumber}</g:else>
                        </strong></li>
            ...
            <tr>
                ...
                <td colspan="6" style="vertical-align:top;">
                    <ul>
                        ...
                        <li><b class="tab">Place of Supply</b>: &nbsp;${custcity?.districtName}</li>
                        <li><b class="tab">Lr No.</b>:  ${transportDetails?.lrNumber}</li>
                        <li><b class="tab">Lr Date.</b>:<span id="poDate2"></span></li>
                    </ul>
                ...
                <td colspan="6" style="vertical-align:top;">
                    <ul>
                        ...
                        <li><b class="tab">Place of Supply</b>: &nbsp;${custcity?.districtName}</li>
                        <li><b class="tab">Lr No.</b>:  ${transportDetails?.lrNumber}</li>
                        <li><b class="tab">Lr Date.</b>:<span id="poDate1"></span></li>
                    </ul>
                </td>
            ...
            <g:each var="key, groupData" in="${groupDetails}" status="i">
                ...
                <g:each var="pd" in="${groupData}" status="j">
                    ...
                    <tr>
                        ...
                        <td  colspan="2">${String.format("%.2f", pd.amount)}</td>
                    </tr>
                </g:each>
                <tr>
                    <td colspan="11">
        ...
        <tr style="border: 1px solid #ffffff">
            <td colspan="13" style="border: 0"><g:if test="${sampleInvDetail.billStatus == 'CANCELLED'}">
                <div id="watermark" class="print-watermark">CANCELLED</div>
            </g:if>
                <g:elseif test="${sampleInvDetail.billStatus == 'DRAFT'}">
                    <div id="watermark" class="print-watermark">DRAFT</div>
                </g:elseif>
                <p><u>Note:</u> <span>${sampleInvDetail?.publicNote}</span></p>
                ...
                <g:each var="t" in="${termsConditions}" status="i">
                    <g:if test="${t?.form?.formType == Constants.SAMPLE_INVOCIE && t?.deleted == false}">
...
<script>
    window.onload = function () {
       ...
       /* var css = '@page { size: landscape; }',
        ...
        var invDate = new Date('${sampleInvDetail.dateCreated}');
        var dueDate = new Date('${sampleInvDetail.dueDate}');
        ...
        <g:if test="${sampleInvDetail?.refDate!=null}">
    ...
    var qrText = '${sampleInvDetail.invoiceNumber}';
    <g:if test="${irnDetails != null}">
