                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="typography-line">
                            <h6 style="font-size: 13px;">Invoice Date: <span id="invoiceDate" style="font-size: 13px; font-weight: normal;"></span></h6>
                            <h6 style="font-size: 13px;">Due Date: <span id="dueDate" style="font-size: 13px; font-weight: normal;"></span></h6>
                        </div>
                    </div>
                </div>
