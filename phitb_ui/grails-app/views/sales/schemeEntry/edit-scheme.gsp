                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slab1BulkStatus"
                                                           class="form-control slab1BulkStatus" value="${scheme.slab1BulkStatus}"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slab2Status"
                                                           class="form-control slab2Status" value="${scheme.slab2Status}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slab3BulkStatus"
                                                           class="form-control slab3BulkStatus" value="${scheme.slab3BulkStatus}"
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slab3Status"
                                                           class="form-control slab3Status" value="${scheme.slab3Status}"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slabValidityFrom"
                                                           class="form-control slabValidityFrom date" value="${scheme.slabValidityFrom}"
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="slabValidityTo"
                                                           class="form-control slabValidityTo date" value="${scheme.slabValidityTo}"
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="text" id="specialDiscount"
                                                           class="form-control specialDiscount" value="${scheme.specialDiscount}"
                                                ...
                                                <div class="col-lg-6 form-group  form-float">
                                                    ...
                                                    <input type="number" id="specialRate"
                                                           class="form-control specialRate"  value="${scheme.specialRate}"
