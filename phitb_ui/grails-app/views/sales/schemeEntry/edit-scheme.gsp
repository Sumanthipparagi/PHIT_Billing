...
<head>
    ...
    <title>:: PharmIt :: Scheme Entry</title>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    %{--                    </div>--}%
                    <div class="body">
                        <form action="/update-scheme-entry/${scheme.id}" id="form_validation" method="POST" role="form"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <select class="form-control show-tick productId" name="productId" id="productId"
                                            onchange="getBatches(this.value)" required>
                                        <option value="">--Please Select--</option>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <select class="form-control show-tick batch" name="batch" id="batch" required>
...
%{--                                        </g:each>--}%
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab1MinQty" class="form-control slab1MinQty"
                                           name="slab1MinQty" placeholder="Slab 1 Min Quantity" value="${scheme.slab1MinQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab1SchemeQty" class="form-control slab1SchemeQty"
                                           name="slab1SchemeQty" placeholder="Slab 1 Scheme Quantity" value="${scheme.slab1SchemeQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab1BulkStatus" class="form-control slab1BulkStatus"
                                           name="slab1BulkStatus" placeholder=" Slab 1 bulk Status" value="${scheme.slab1BulkStatus}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab1Status" class="form-control slab1Status"
                                           name="slab1Status" placeholder="Slab 1 Status" value="${scheme.slab1Status}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab2MinQty" class="form-control slab2MinQty"
                                           name="slab2MinQty" placeholder="Slab 2 Min Quantity" value="${scheme.slab2MinQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab2SchemeQty" class="form-control slab2SchemeQty"
                                           name="slab2SchemeQty" placeholder="Slab 2 Scheme Quantity"  value="${scheme.slab2SchemeQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab2BulkStatus" class="form-control slab2BulkStatus"
                                           name="slab2BulkStatus" placeholder="Slab 2 Bulk Status" value="${scheme.slab2BulkStatus}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab2Status" class="form-control slab2Status"
                                           name="slab2Status" placeholder="Slab 2 Status" value="${scheme.slab2Status}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab3MinQty" class="form-control slab3MinQty"
                                           name="slab3MinQty" placeholder="Slab 3 Min Quantity" value="${scheme.slab3MinQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab3SchemeQty" class="form-control slab3SchemeQty"
                                           name="slab3SchemeQty" placeholder="Slab 3 Scheme Quantity" value="${scheme.slab3SchemeQty}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab3BulkStatus" class="form-control slab3BulkStatus"
                                           name="slab3BulkStatus" placeholder="Slab 3 Bulk Status" value="${scheme.slab3BulkStatus}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slab3Status" class="form-control slab3Status"
                                           name="slab3Status" placeholder="Slab 3 Status" value="${scheme.slab3Status}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slabValidityFrom" class="form-control slabValidityFrom date"
                                           name="slabValidityFrom" placeholder="Slab Validity From" value="${scheme.slabValidityFrom}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="slabValidityTo" class="form-control slabValidityTo date"
                                           name="slabValidityTo" placeholder=" Slab Validity to"  value="${scheme.slabValidityTo}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="specialDiscount" class="form-control specialDiscount"
                                           name="specialDiscount" placeholder="Special Discount"  value="${scheme.specialDiscount}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="specialDiscountValidFrom"
                                           ...
                                           name="specialDiscountValidFrom" placeholder="Special Discount Valid From"  value="${scheme.specialDiscountValidFrom}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="specialDiscountValidTo"
                                           ...
                                           value="${scheme.specialDiscountValidTo}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="specialRateValidFrom"
                                           ...
                                           value="${scheme.specialRateValidFrom.split("T")[0]}"
                                           required/>
                                </div>
                                ...
                                <div class="col-lg-6 form-group  form-float">
                                    ...
                                    <input type="text" id="specialRateValidTo"
                                           ...
                                           value="${scheme.specialRateValidTo}"
                                           required/>
                                </div>
