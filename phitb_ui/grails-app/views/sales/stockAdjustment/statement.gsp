                                ...
                                <div class="form-group">
                                    <div class="input-group inlineblock">
                                        ...
                                        <button class="input-group-btn btn btn-info btn-sm"
                                                onclick="getReport()">Get Logs</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function getReport() {
        ...
        $.ajax({
            url: "/stock-adjustment-datatable?dateRange="+dateRange,
            type: "GET",
            contentType: false,
            processData: false,
            success: function (data) {
                var content = "";
                var mainTableHeader =
                    "<table class='table table-bordered table-sm' style='width: 100%;'><thead>" +
                    ...
                    "<tr><th data-f-bold='true' colspan='11'>Date: " +
                    dateRange + "</th></tr>" +
                    ...
                    "<tr><th data-f-bold='true'>Product Name</th><th data-f-bold='true'>Batch Number</th><th data-f-bold='true'>Sqty</th><th data-f-bold='true'>Fqty</th><th data-f-bold='true'>Date Created</th><th data-f-bold='true'>Manf. Date</th><th data-f-bold='true'>Exp.Date</th></th><th data-f-bold='true'>PRate</th><th data-f-bold='true'>SRate</th><th data-f-bold='true'>MRP</th><th data-f-bold='true'>GST</th></tr>" +
                    "</thead><tbody>";
                var stockDetails = "";
                $.each(data, function (key, value) {
                    ...
                    stockDetails = "<tr>" +
                                ...
                                "<td>" + moment(value?.manfDate).format('DD-MM-YYYY') + "</td>" +
                                "<td>" + moment(value?.expDate).format('DD-MM-YYYY') + "</td>" +
                                "<td>" + value?.pRate + "</td>" +
                                "<td>" + value?.sRate + "</td>" +
                                "<td>" + value?.mrp + "</td>" +
                                "<td>" + value?.gst + "</td>" +
                ...
                if(data.length === 0){
                    content
                        ="<tr><td colspan='11' style='text-align: center;font-size: 20px;font-weight: bold;'>No data found!</td></tr>"
                }
    ...
    $("#btnExport").click(function () {
        ...
        TableToExcel.convert(table, {
            name: 'stock-adjustment-list.xlsx',
            sheet: {
