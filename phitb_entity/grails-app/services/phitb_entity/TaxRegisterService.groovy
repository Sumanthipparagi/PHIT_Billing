...
class TaxRegisterService {
    ...
    TaxRegister save(JSONObject jsonObject) {
        ...
        taxRegister.taxValue = Long.parseLong(jsonObject.get("taxValue").toString())
        taxRegister.salesTaxType = Long.parseLong(jsonObject.get("taxValue").toString())
        taxRegister.salesSgst = Long.parseLong(jsonObject.get("salesSgst").toString())
        taxRegister.salesCgst = Long.parseLong(jsonObject.get("salesCgst").toString())
        taxRegister.purchaseTaxType = jsonObject.get("purchaseTaxType").toString()
        taxRegister.purchaseSgst = Long.parseLong(jsonObject.get("purchaseSgst").toString())
        taxRegister.purchaseCgst = Long.parseLong(jsonObject.get("purchaseCgst").toString())
        taxRegister.salesIgst = Long.parseLong(jsonObject.get("salesIgst").toString())
        taxRegister.purchaseIgst = Long.parseLong(jsonObject.get("purchaseIgst").toString())
