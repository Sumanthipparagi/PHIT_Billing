...
class SeriesMasterService {
    ...
    SeriesMaster save(JSONObject jsonObject) {
        ...
        seriesMaster.saleOrderId = Long.parseLong(jsonObject.get("saleOrderId").toString())
        ...
        seriesMaster.sampleInvoiceId = Long.parseLong(jsonObject.get("sampleInvoiceId").toString())
        seriesMaster.goodsTransferId = Long.parseLong(jsonObject.get("goodsTransferId").toString())
