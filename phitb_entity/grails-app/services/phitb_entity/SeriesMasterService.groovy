...
class SeriesMasterService {
    ...
    SeriesMaster save(JSONObject jsonObject) {
        ...
        seriesMaster.orderId = Long.parseLong(jsonObject.get("orderId").toString())
        ...
        seriesMaster.entityTypeId = Long.parseLong(jsonObject.get("entityTypeId").toString())
        seriesMaster.entityId = Long.parseLong(jsonObject.get("entityId").toString())
        seriesMaster.createdUser = Long.parseLong(jsonObject.get("createdUser").toString())
        seriesMaster.modifiedUser = Long.parseLong(jsonObject.get("modifiedUser").toString())
