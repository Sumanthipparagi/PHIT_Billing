...
class RouteRegisterService
{
    ...
    RouteRegister save(JSONObject jsonObject)
    {
        ...
        routeRegister.areaManager = Long.parseLong(jsonObject.get("areaManager").toString())
        ...
        routeRegister.apprExpense = Long.parseLong(jsonObject.get("apprExpense").toString())
