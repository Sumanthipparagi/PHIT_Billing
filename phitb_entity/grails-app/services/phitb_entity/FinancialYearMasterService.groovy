...
class FinancialYearMasterService {
    ...
    FinancialYearMaster save(JSONObject jsonObject) {
        ...
        financialYearMaster.entityTypeId = Long.parseLong(jsonObject.get("entityTypeId").toString())
        financialYearMaster.entityId = Long.parseLong(jsonObject.get("entityId").toString())
        financialYearMaster.modifiedUser = Long.parseLong(jsonObject.get("modifiedUser").toString())
        financialYearMaster.createdUser = Long.parseLong(jsonObject.get("createdUser").toString())
